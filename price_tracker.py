"""
Canadian Tire Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from Canadian Tire.

Docs  : https://docs.brightdata.de/scraping-automation/web-scraper-api/overview
Info  : https://brightdata.de/products/insights/price-tracker/canadian-tire
"""
...
# Set your Web Scraper ID after building your Canadian Tire scraper:
# https://brightdata.de/products/web-scraper/canadian-tire
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Canadian Tire scraper at: https://brightdata.de/products/web-scraper/canadian-tire\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of Canadian Tire product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover Canadian Tire products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a Canadian Tire category page.

    Example:
        results = discover_by_category("https://canadiantire.ca/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.canadiantire.ca/product/sample-item-123456",
        # Add more Canadian Tire product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "canadian-tire_prices.json"
    ...
    # cat_results = discover_by_category("https://canadiantire.ca/category/sample", limit=50)
